...
export const notificationChannelEnum = pgEnum('notification_channel', [
  'email', 'sms', 'push', 'whatsapp', 'slack', 'teams', 'discord', 'webhook',
]);
...
export const notificationTemplatesTable = pgTable('notification_templates', {
  ...
  ...timestamps,
}, (t) => ({ tenantKeyChannelIdx: uniqueIndex('notification_templates_tenant_key_channel_idx').on(t.tenantId, t.key, t.channel) }));

export const notificationStatusEnum = pgEnum('notification_status', ['queued', 'sent', 'delivered', 'failed', 'read']);
